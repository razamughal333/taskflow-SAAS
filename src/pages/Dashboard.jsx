      ...
      <div className="max-w-5xl mx-auto px-4 py-8 sm:px-6 fade-in">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
          ...
          <input
            ...
            className="w-full sm:w-64 px-3 py-2 rounded-lg border border-stone-300 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500"
          />
        </div>
        ...
        {atLimit ? (
          ...
          <form
            ...
            className="bg-white border border-stone-200 rounded-xl p-4 mb-6 flex flex-col sm:flex-row gap-3"
          >
            <input
              ref={nameInputRef}
              value={name}
