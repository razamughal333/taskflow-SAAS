...
function Dashboard() {
  ...
  const handleRemove = useCallback((id) => removeClient(id), [removeClient]);
  ...
  return (
    <div className="min-h-screen bg-[url('/bgimage.png')] bg-cover bg-center bg-fixed relative">
      <div className="absolute inset-0 bg-white/50 dark:bg-slate-900/80 transition-colors duration-300"></div>
        ...
        <div className="max-w-5xl mx-auto px-4 py-8 sm:px-6 fade-in">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
            ...
            <input
              ...
              className="w-full sm:w-64 px-3 py-2 text-white-800 rounded-lg border border-stone-300 dark:border-slate-600 dark:bg-slate-800 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-teal-500"
            />
          </div>
